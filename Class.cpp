...
class Player
{
    private:  //anything you write down into the private "section" will be only accesible by the function
        int m_Name; //when you have a varible in private we write "m_" befere the name of the variable. Sowe know it is in private
